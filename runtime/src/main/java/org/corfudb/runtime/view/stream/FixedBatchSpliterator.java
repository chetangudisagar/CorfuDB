...
public abstract class FixedBatchSpliterator<T> implements Spliterator<T> {
    private static final int DEFAULT_BATCH = 1 << 10;
    ...
    // HoldingConsumer is used to carry the object from tryAdvance
    // This helper class is borrowed from java.util.Spliterators
